...
<table class="table">
  ...
  <tr>
    ...
    <td>
      <a href="http://www.le-mouel.net">{% img no-border /images/gloss-browser-icons/png/32x32/safari.png 32 32 "Homepage" "Homepage" %}</a>
  ...
  <tr>
    ...
    <td>
      <a href="http://julien.ponge.info/">{% img no-border /images/gloss-browser-icons/png/32x32/chrome2.png "Homepage" "Homepage" %}</a>
